...
@Component({
  selector: 'app-flight-card-round-trip',
  templateUrl: './flight-card-round-trip.component.html',
  styleUrls: ['./flight-card-round-trip.component.scss']
})
export class FlightCardRoundTripComponent implements OnInit {
